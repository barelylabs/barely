...
export const authEnv = createEnv({
	...
	client: {
		...
		NEXT_PUBLIC_APP_FM_BASE_URL: z.string(),
		NEXT_PUBLIC_APP_INVOICE_BASE_URL: z.string(),
		NEXT_PUBLIC_BIO_BASE_URL: z.string(),
		NEXT_PUBLIC_CART_BASE_URL: z.string(),
		NEXT_PUBLIC_FM_BASE_URL: z.string(),
		NEXT_PUBLIC_INVOICE_BASE_URL: z.string(),
		...
		NEXT_PUBLIC_INVOICE_DEV_PORT: z.string().optional(),
	...
	experimental__runtimeEnv: {
		...
		NEXT_PUBLIC_APP_INVOICE_BASE_URL: process.env.NEXT_PUBLIC_APP_INVOICE_BASE_URL,
		...
		NEXT_PUBLIC_INVOICE_BASE_URL: process.env.NEXT_PUBLIC_INVOICE_BASE_URL,
		...
		NEXT_PUBLIC_INVOICE_DEV_PORT: process.env.NEXT_PUBLIC_INVOICE_DEV_PORT,
