...
import { _Playlists_To_Genres, _Tracks_To_Genres, Genres } from "./genre.sql";
...
export const insertPlaylistGenreSchema = createInsertSchema(
  _Playlists_To_Genres,
  {
    genreId: genreIdSchema,
  },
);
export const selectPlaylistGenreSchema = createSelectSchema(
  _Playlists_To_Genres,
  {
    genreId: genreIdSchema,
  },
