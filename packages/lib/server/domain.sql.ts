...
export const Domains = pgTable(
  "Domains",
  {
    ...
    isPrimaryLinkDomain: boolean("isPrimaryLinkDomain")
      .default(false)
      .notNull(),
    isPrimaryBioDomain: boolean("isPrimaryBioDomain").default(false).notNull(),
    isPrimaryPressDomain: boolean("isPrimaryPressDomain")
      .default(false)
      .notNull(),
  ...
  (domain) => ({
    ...
    lastCheckedAt: index("Domains_lastCheckedAt_idx")
      .on(domain.lastCheckedAt)
      .asc(),
  }),
);
