...
export const PressKits = pgTable("PressKits", {
  ...
  overrideWorkspaceBio: boolean("overrideWorkspaceBio")
    .default(false)
    .notNull(),
  ...
  pressQuotes:
    jsonb("pressQuotes").$type<
      { quote: string; source: string; link?: string }[]
    >(),
  ...
  showSpotifyFollowers: boolean("showSpotifyFollowers")
    .default(false)
    .notNull(),
  showSpotifyMonthlyListeners: boolean("showSpotifyMonthlyListeners")
    .default(false)
    .notNull(),
  showYoutubeSubscribers: boolean("showYoutubeSubscribers")
    .default(false)
    .notNull(),
  showTiktokFollowers: boolean("showTiktokFollowers").default(false).notNull(),
  showInstagramFollowers: boolean("showInstagramFollowers")
    .default(false)
    .notNull(),
  showXFollowers: boolean("showXFollowers").default(false).notNull(),
  showFacebookFollowers: boolean("showFacebookFollowers")
    .default(false)
    .notNull(),
});
