...
export const createFormResponseSchema = insertFormResponseSchema.omit({ id: true });
export const updateFormResponseSchema = insertFormResponseSchema
	.partial()
	.required({ id: true });
export const upsertFormResponseSchema = insertFormResponseSchema.partial({ id: true });
