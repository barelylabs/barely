...
import { CampaignWithWorkspaceAndTrackAndGenres } from './campaign.schema';
...
import { InsertTransactionLineItem } from './transaction-line-item.schema';
import { TransactionLineItems } from './transaction-line-item.sql';
import { InsertTransaction } from './transaction.schema';
import { Transactions } from './transaction.sql';
import { User } from './user.schema';
import { Users } from './user.sql';
import { Workspace } from './workspace.schema';
import { PlanType, WORKSPACE_PLANS } from './workspace.settings';
...
export async function createPlanCheckoutLink(props: {
	...
	const cancelUrl =
		`${APP_BASE_URL}/` + props.cancelPath ?? `${props.workspace.handle}/settings/billing`;
