...
export const AudienceInterest_Relations = relations(
  AudienceInterests,
  ({ many }) => ({
    // many-to-many
...
export const AudienceInterestGroups = pgTable(
  ...
  (table) => {
    return {
      ...
      workspace: index("AudienceInterestGroups_workspace_idx").on(
        table.workspaceId,
      ),
    };
  },
...
export const _AudienceInterests_To_AudienceInterestGroup_Relations = relations(
  ...
  ({ one }) => ({
    ...
    audienceInterestGroup: one(AudienceInterestGroups, {
      fields: [
        _AudienceInterests_To_AudienceInterestGroups.audienceInterestGroupId,
      ],
      references: [AudienceInterestGroups.id],
    }),
  }),
