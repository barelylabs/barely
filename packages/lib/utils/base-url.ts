...
export const NEXT_PUBLIC_APP_BASE_URL = getBaseUrl(process.env.NEXT_PUBLIC_APP_DEV_PORT);
export const NEXT_PUBLIC_WWW_BASE_URL = getBaseUrl(process.env.NEXT_PUBLIC_WWW_DEV_PORT);
