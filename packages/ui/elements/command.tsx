...
>(({ className, ...props }, ref) => (
	...
	>
		...
		<CommandPrimitive.Input
			ref={ref}
			className={cn(
				'flex h-11 w-full border-0 focus:border-0 focus:ring-0 active:border-0 rounded-md bg-transparent py-3 text-sm outline-none placeholder:text-slate-400 disabled:cursor-not-allowed disabled:opacity-50 dark:text-slate-50',
				className,
			)}
			{...props}
		/>
