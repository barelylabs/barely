...
>(({ className, isSelected, ...props }, ref) => (
	<CommandPrimitive.Item
		ref={ref}
		className={cn(
			'relative flex cursor-default select-none flex-row items-center gap-2 rounded-sm border-transparent px-1.5 py-1.5 text-sm outline-none aria-selected:border-red aria-selected:bg-muted aria-selected:text-accent-foreground data-[disabled]:pointer-events-none data-[disabled]:opacity-50',
			isSelected &&
