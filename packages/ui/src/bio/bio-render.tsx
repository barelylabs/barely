...
// import type { Bio, BioBlock, BioLink, BrandKit } from '@barely/validators';
...
// 	const { headerStyle, showShareButton, showSubscribeButton } = bio;
...
// 				{isPreview &&
// 					(blocks.length === 0 || blocks.every(b => b.links.length === 0)) && (
// 						<div
// 							className={cn(
