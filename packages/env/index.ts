...
function safePick<T extends z.ZodObject<z.ZodRawShape>, K extends keyof z.infer<T>>(
	schema: T,
	keys: K[],
) {
...
export const allClientEnvKeys = Object.keys(clientEnvSchema.shape) as (keyof z.infer<
	typeof clientEnvSchema
>)[];
export const allServerEnvKeys = Object.keys(serverEnvSchema.shape) as (keyof z.infer<
