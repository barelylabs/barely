...
export default function NotFound() {
  return (
    <div className="flex flex-col min-h-screen pt-16 pb-12 align-middle bg-purple-900">
      <main className="flex flex-col justify-center flex-grow w-full px-4 mx-auto max-w-7xl sm:px-2 lg:px-8">
