...
import type { CartRouter } from '@barely/api/public/cart.router';
...
import { cartRouter } from '@barely/api/public/cart.router';
...
export const trpc = createTRPCOptionsProxy<CartRouter>({
	router: cartRouter,
	ctx: createContext,
	queryClient: getQueryClient,
});

export const trpcCaller = cartRouter.createCaller(createContext);
...
export const fetchBrandKitByHandle = cache(async (handle: string) => {
	return await trpcCaller.brandKitByHandle({ handle });
});
