...
import { invoiceRenderRouter } from '@barely/api/public/invoice-render.router';
...
export const trpc = createTRPCOptionsProxy<InvoiceRenderRouter>({
	router: invoiceRenderRouter,
	ctx: createContext,
	queryClient: getQueryClient,
});

export const trpcCaller = invoiceRenderRouter.createCaller(createContext);
