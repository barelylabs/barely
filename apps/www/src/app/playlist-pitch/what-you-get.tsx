    ...
    <div className="mt-10 flex w-full flex-col items-center space-y-4 text-center sm:mt-20">
      ...
      <AnimateOnScroll fade slideFrom="bottom">
        <Lead className=" max-w-2xl">
          Designed to be the{" "}
          <span className="font-medium underline">first step</span> in your
          marketing strategy, playlist.pitch campaigns combine access to
          relevant listeners with actionable steps to continue growing your
          audience.
        </Lead>
      </AnimateOnScroll>
