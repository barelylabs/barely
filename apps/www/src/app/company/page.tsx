	...
	return (
		<Container className='mt-16'>
			...
			<Lead className='mt-6 max-w-3xl'>
				We’re on a mission to transform revenue organizations by harnessing vast amounts
				of illegally acquired customer data.
			</Lead>
			<section className='mt-16 grid grid-cols-1 lg:grid-cols-2 lg:gap-12'>
				<div className='max-w-lg'>
					...
					<p className='mt-6 text-sm/6 text-gray-600'>
						...
						source and close deals. Our mission is to provide our customers with an unfair
						advantage over both their competitors and potential customers through insight
						and analysis. We’ll stop at nothing to get you the data you need to close a
						deal.
					</p>
					<p className='mt-8 text-sm/6 text-gray-600'>
						We’re customer-obsessed — putting the time in to build a detailed financial
						picture of every one of our customers so that we know more about your business
						than you do. We are in this together, mostly because we are all implicated in
						large-scale financial crime. In our history as a company, we’ve never lost a
...
function Team() {
	return (
		<Container className='mt-32'>
			...
			<Lead className='mt-6 max-w-3xl'>
				Radiant is founded by two of the best sellers in the business and backed by
				investors who look the other way.
			</Lead>
			<div className='mt-12 grid grid-cols-1 gap-12 lg:grid-cols-2'>
				<div className='max-w-lg'>
					<p className='text-sm/6 text-gray-600'>
						Years ago, while working as sales associates at rival companies, Thomas, Ben,
						and Natalie were discussing a big client they had all been competing for.
						Joking about seeing the terms of each other’s offers, they had an idea: what
						if they shared data to win deals and split the commission behind their
						companies’ backs? It turned out to be an incredible success, and that idea
...
function Investors() {
	return (
		<Container className='mt-32'>
			...
			<Lead className='mt-6 max-w-3xl'>
				We are fortunate to be backed by the best investors in the industry — both literal
				and metaphorical partners in crime.
			</Lead>
			<Subheading as='h3' className='mt-24'>
				Venture Capital
			</Subheading>
			...
			>
				<li>
					...
					<p className='mt-6 max-w-lg text-sm/6 text-gray-500'>
						...
						entrepreneurs who explore grey areas in financial and privacy law. Their deep
						industry expertise and extensive political lobbying provide their portfolio
						companies with favorable regulation and direct access to lawmakers.
					</p>
				</li>
				<li>
					<img alt='Deccel' src='/investors/deccel.svg' className='h-14' />
					<p className='mt-6 max-w-lg text-sm/6 text-gray-500'>
						Deccel has been at the forefront of innovation, investing in pioneering
						companies across various sectors, including technology, consumer goods, and
						healthcare. Their philosophy of ‘plausible deniability’ and dedication to
						looking the other way have helped produce some of the world’s most
			...
			<figure className='relative p-10'>
				<blockquote>
					<p className="relative text-xl/7 text-white before:absolute before:-translate-x-full before:content-['“'] after:absolute after:content-['”']">
						We&apos;ve managed to put two of our main competitors out of business in 6
						months.
					</p>
				</blockquote>
