...
const Brand = () => {
  return (
    <div className="flex flex-col space-y-4 ">
      ...
      <Text muted>
        Build trust and increase brand recognition across all channels to create
        a memorable (and profitable) customer journey - without need to cobble
        together and rely on third-party tools.
      </Text>
      <FeatureCard
      ...
      >
        Build trust and create a lasting impression with personally branded
        URLs.
      </FeatureCard>
      <FeatureCard
        Icon={MdQrCode}
...
const Track = () => {
  return (
    <div className="flex flex-col space-y-4">
      ...
      <Text muted>
        Track clicks, monitor engagement, and gain insights into the performance
        of your campaigns in real-time. Our friendly dashboard helps you make
        data-driven decisions and optimize your marketing strategies for optimal
        results.
      </Text>
      <FeatureCard
      ...
      Booking gigs for a tour or need to know which stores should stock your
      upcoming vinyl? Learn where your fans are and target those areas.
      <FeatureCard
        Icon={FiActivity}
        iconColor="blue"
...
const Grow = () => {
  return (
    <div className="flex flex-col space-y-4">
      ...
      <Text muted>
        Scale your business and fanbase with a suite of tools designed to lower
        your cost per sale, increase average order value, and generate happy
        fans who can’t stop talking about you.
      </Text>
      ...
      >
        Take users straight to the content you want them to see within the most
        popular apps.
      </FeatureCard>
