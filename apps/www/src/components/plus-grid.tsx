	...
	return (
		...
		>
			...
			>
				...
				<div className='absolute inset-x-0 bottom-0 hidden border-b border-white/10 group-last/row:block'></div>
...
export function PlusGridIcon({
	...
	return (
		<svg
			viewBox='0 0 15 15'
			aria-hidden='true'
			className={clsx(className, 'absolute size-[15px] fill-white/20', yClass, xClass)}
		>
