...
export default function SignInPage() {
	const magic =
		typeof window !== 'undefined'
			? new Magic(env.NEXT_PUBLIC_MAGIC_PUBLISHABLE_KEY)
			: null;
	...
	const onSubmit = async ({ email }: { email: string }) => {
		...
		// const signInResponse = await signIn('credentials', { didToken, callbackUrl: '/' });
	...
	return (
		<>
			...
			<div className='flex min-h-full flex-col justify-center py-12 sm:px-6 lg:px-8'>
				{/* <pre> {JSON.stringify(parsedEnv, null, 2)}</pre> */}
