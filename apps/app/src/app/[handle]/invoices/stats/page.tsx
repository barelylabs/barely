						...
						<Card>
							<div className='flex flex-col items-center gap-4 p-12 text-center'>
								...
								<div className='space-y-2'>
									<Text variant='lg/semibold'>No invoices yet</Text>
									<Text variant='sm/normal' className='text-muted-foreground'>
										Create your first invoice to start tracking revenue, outstanding
										payments, and more.
									</Text>
								</div>
								<Button href={`/${awaitedParams.handle}/invoices/new`}>
