...
export function PressKitForm({
  ...
  const { handle, bio, bookingEmail, bookingName, bookingTitle } =
    useWorkspace();
  ...
  const { data: mixtapeOptions } = api.mixtape.byWorkspace.useQuery(
    ...
    {
      select: (data) =>
        data.map((mixtape) => ({ label: mixtape.name, value: mixtape.id })),
    },
  );
  ...
  const [pressPhotos, setPressPhotos] = useState<SortableMedia[]>(
    ...
    <>
      ...
      >
        <PressKitCard
          title="Bio"
          Toggle={
            <SwitchField control={form.control} name="showBio" size="md" />
          }
        >
          {form.watch("showBio") && (
            <SwitchField
        ...
        <PressKitCard
          title="Mixtape"
          Toggle={
            <SwitchField control={form.control} name="showMixtape" size="md" />
          }
        >
        ...
        <PressKitCard
          title="Booking"
          Toggle={
            <SwitchField control={form.control} name="showBooking" size="md" />
          }
        >
        ...
        >
          ...
          <div className="justify-left flex flex-row">
            <Button
              ...
              startIcon="add"
              onClick={() =>
                appendPressQuote({ quote: "", source: "", link: "" })
              }
            />
          </div>
        </PressKitCard>
        ...
        <PressKitCard
          title="Videos"
          Toggle={
            <SwitchField control={form.control} name="showVideos" size="md" />
          }
        >
