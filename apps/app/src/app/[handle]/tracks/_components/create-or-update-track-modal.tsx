...
export function CreateOrUpdateTrackModal(props: { mode: "create" | "update" }) {
  ...
  // MASTERS
  const masterCompressed = selectedTrack?.audioFiles?.find(
  ...
  /* modal */
  const showModal =
    mode === "create" ? showCreateTrackModal : showEditTrackModal;
  const setShowModal =
      ...
      <Form form={form} onSubmit={handleSubmit}>
        ...
        <ModalFooter>
          <SubmitButton fullWidth disabled={submitDisabled}>
            {selectedTrack ? "Save Track" : "Create Track"}
          </SubmitButton>
        </ModalFooter>
      </Form>
    </Modal>
