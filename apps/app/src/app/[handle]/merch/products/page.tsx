...
import { ArchiveOrDeleteProductModal } from '~/app/[handle]/merch/products/_components/archive-or-delete-product-modal';
import { CreateOrUpdateProductModal } from '~/app/[handle]/merch/products/_components/create-or-update-product-modal';
import { CreateProductButton } from '~/app/[handle]/merch/products/_components/create-product-button';
import { ProductFilters } from '~/app/[handle]/merch/products/_components/product-filters';
import { ProductHotkeys } from '~/app/[handle]/merch/products/_components/product-hotkeys';
...
export default async function ProductsPage({
	...
	if (!parsedFilters.success) {
		...
		redirect(`/${awaitedParams.handle}/merch/products`);
	}
