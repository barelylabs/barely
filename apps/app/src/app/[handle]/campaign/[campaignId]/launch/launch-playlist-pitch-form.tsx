...
export function LaunchPlaylistPitchForm(props: LaunchPlaylistPitchFormProps) {
  ...
  const createCheckout =
    api.campaign.createPlaylistPitchCheckoutLink.useMutation({
    ...
    <Form form={form} onSubmit={handleCheckout}>
      ...
      <div className="-top-10 flex flex-row items-start gap-1 text-muted-foreground">
        ...
        <Text variant="xs/light" muted>
          While you are never guaranteed placements, you will always receive
          feedback. At the end of your campaign, you will receive a full refund
          for any incomplete reviews.
        </Text>
      </div>
