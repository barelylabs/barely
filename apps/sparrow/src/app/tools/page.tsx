...
export const metadata: Metadata = {
	title: 'Our Tools - barely.io Platform | Barely Sparrow',
	description:
		'Stop juggling 10 different platforms. barely.io brings all your music marketing tools together in one integrated system built specifically for artists.',
};
				...
				<div className='mx-auto max-w-6xl text-center'>
					<AnimatedSection animation='fade-up'>
						...
						<p className='mx-auto max-w-3xl text-xl text-white/70 md:text-2xl'>
							Stop wasting 2+ hours/week managing 10 different platforms. barely.io brings
				...
				<div className='mx-auto max-w-4xl text-center'>
					<AnimatedSection animation='scale'>
						...
						<p className='mb-8 text-xl text-white/70'>
							...
							barely.io gives you professional tools that actually work together.
						</p>
