...
export const metadata: Metadata = {
  ...
  description: 'Choose the service that fits your needs and budget. From DIY coaching to full campaign execution, all with complete transparency.',
};
          ...
          <div className="space-y-8">
            <AnimatedSection animation="fade-up" delay={200}>
              <div className="glass rounded-xl p-6">
                <H size="4" className="mb-4 gradient-text">Choose Bedroom+ if:</H>
            ...
            <AnimatedSection animation="fade-up" delay={300}>
              <div className="glass rounded-xl p-6">
                <H size="4" className="mb-4 gradient-text">Choose Rising+ if:</H>
                <ul className="space-y-2 text-white/80">
      ...
      <section className="py-12 px-4 sm:px-6 lg:px-8 bg-white/5">
        <div className="mx-auto max-w-4xl">
          ...
          <div className="space-y-6">
            <AnimatedSection animation="fade-up" delay={200}>
              <div className="glass rounded-xl p-6">
                <H size="5" className="mb-3">Can I switch between service tiers?</H>
                <p className="text-white/70">
                  Absolutely. Many artists start with Bedroom+ to learn the fundamentals, then 
                  upgrade to Rising+ or Breakout+ as they grow. You can change tiers at any time.
                </p>
              </div>
            </AnimatedSection>
            ...
            <AnimatedSection animation="fade-up" delay={300}>
              <div className="glass rounded-xl p-6">
                <H size="5" className="mb-3">What makes you different from other agencies?</H>
                <p className="text-white/70">
                  Complete transparency. I built the tools from scratch (open-source), show you 
                  exactly how campaigns work, and report on everything. No black boxes, no fake 
                  guarantees, just data-driven strategies that actually work.
                </p>
              </div>
            </AnimatedSection>
            ...
            <AnimatedSection animation="fade-up" delay={400}>
              <div className="glass rounded-xl p-6">
                <H size="5" className="mb-3">Do you guarantee streaming numbers?</H>
                <p className="text-white/70">
                  No, and run from anyone who does. What I guarantee is transparent reporting, 
                  data-driven strategies, and campaigns that follow platform guidelines. Real 
                  growth takes time and the right approach.
                </p>
              </div>
            </AnimatedSection>
          </div>
