...
import { Textarea } from '@barely/ui/elements/textarea';
...
export function ContactModal({ showModal, setShowModal, preSelectedService }: ContactModalProps) {
  ...
  return (
    <Modal 
      ...
      className="max-w-lg bg-[#0A0A0B] border-white/10"
    >
      <ModalHeader
      ...
      <ModalBody className="bg-[#0A0A0B]">
        {submitSuccess ? (
          <div className="text-center py-8">
            ...
            <p className="text-xl text-white font-semibold mb-2">Message Sent!</p>
          ...
          <>
            <form onSubmit={form.handleSubmit(handleSubmit)} className="space-y-4">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  <label htmlFor="artistName" className="block text-sm font-medium text-white/70 mb-1">
                    Artist/Band Name
                  </label>
                  <Input
                    id="artistName"
                ...
                <div>
                  <label htmlFor="monthlyListeners" className="block text-sm font-medium text-white/70 mb-1">
                    Monthly Listeners
                  </label>
                  <Input
                    id="monthlyListeners"
              ...
              <div>
                ...
                >
                  ...
                  <option value="bedroom" className="bg-[#0A0A0B]">Bedroom+ ($200/month)</option>
                  <option value="rising" className="bg-[#0A0A0B]">Rising+ ($750/month)</option>
                  <option value="breakout" className="bg-[#0A0A0B]">Breakout+ ($1,800/month)</option>
                </select>
              </div>
            ...
            <div className="mt-6 pt-6 border-t border-white/10">
              <p className="text-center text-white/70 mb-4">Or book a free strategy call:</p>
              <a 
